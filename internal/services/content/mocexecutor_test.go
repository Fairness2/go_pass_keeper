...
import (
	context "context"
	sql "database/sql"
	repositories "passkeeper/internal/repositories"
	reflect "reflect"
...
// PrepareNamed mocks base method.
func (m *MockITX) PrepareNamed(query string) (repositories.INamedStmt, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PrepareNamed", query)
	ret0, _ := ret[0].(repositories.INamedStmt)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// QueryRowxContext mocks base method.
func (m *MockIStmt) QueryRowxContext(ctx context.Context, arg interface{}) repositories.IRow {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryRowxContext", ctx, arg)
	ret0, _ := ret[0].(repositories.IRow)
	return ret0
}
...
// QueryRowxContext mocks base method.
func (m *MockINamedStmt) QueryRowxContext(ctx context.Context, arg interface{}) repositories.IRow {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryRowxContext", ctx, arg)
	ret0, _ := ret[0].(repositories.IRow)
	return ret0
...
// BeginTxx mocks base method.
func (m *MockSQLExecutor) BeginTxx(ctx context.Context, opts *sql.TxOptions) (repositories.ITX, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BeginTxx", ctx, opts)
...
// PrepareNamed mocks base method.
func (m *MockSQLExecutor) PrepareNamed(query string) (repositories.INamedStmt, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PrepareNamed", query)
	ret0, _ := ret[0].(repositories.INamedStmt)
	ret1, _ := ret[1].(error)
...
// QueryRowContext mocks base method.
func (m *MockSQLExecutor) QueryRowContext(ctx context.Context, query string, args ...any) repositories.IRow {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
// QueryRowxContext mocks base method.
func (m *MockSQLExecutor) QueryRowxContext(ctx context.Context, query string, args ...interface{}) repositories.IRow {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
